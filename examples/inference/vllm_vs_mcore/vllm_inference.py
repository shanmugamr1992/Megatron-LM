...
for prompt_len in prompt_lengths:
    prompt_tokens = torch.randint(low=0, high=vocab_size, size=(prompt_len,))
    prompts.append({'prompt_token_ids': prompt_tokens.tolist()})


"""llm_kwargs = {'model': 'Qwen/Qwen2.5-1.5B', 'served_model_name': 'Qwen/Qwen2.5-1.5B', 'load_format': 'dummy', 'skip_tokenizer_init': True, 'tensor_parallel_size': 1, 'pipeline_parallel_size': 1, 'enable_expert_parallel': False, 'gpu_memory_utilization': 0.6, 'enable_prefix_caching': True, 'dtype': 'bfloat16', 'seed': 0, 'enforce_eager': False, 'max_model_len': 512, 'trust_remote_code': True, 'worker_extension_cls': 'nemo_rl.models.generation.vllm.vllm_backend.VllmInternalWorkerExtension', 'enable_sleep_mode': True, 'disable_log_stats': True, 'logprobs_mode': 'processed_logprobs', 'distributed_executor_backend': None, 'hf_overrides': {}}
"""
llm = vllm.LLM(
    model='Qwen/Qwen2.5-1.5B',
    served_model_name='Qwen/Qwen2.5-1.5B',
    load_format='dummy',
...
# Calculate and print metrics matching mcore script
print("-" * 80)
